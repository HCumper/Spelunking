...
let damageFor attacker =
    // Strength 100 corresponds to baseline 10 damage; larger values scale upward in 10-point steps.
    10 * (max 1 ((attacker.Strength + actionThreshold - 1) / actionThreshold))
